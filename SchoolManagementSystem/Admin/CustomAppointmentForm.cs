...
namespace SchoolManagementSystem.Admin
{
    public partial class CustomAppointmentForm : DevExpress.XtraEditors.XtraForm, IDXManagerPopupMenu
    {
        ...
        {
            string query = "SELECT section_id,name from section where class_id in (" + classid + ")";

            txtSection.Properties.DataSource = fun.FetchDataTable(query);
        ...
        protected virtual void BindControllerToControls()
        {
            ...
            BindProperties(this.txtSection, "EditValue", "Location");
        ...
        protected internal virtual void OnOkButton()
        {
            ...
            if (Controller.IsAppointmentChanged() || Controller.IsNewAppointment || IsAppointmentChanged(Controller.EditedAppointmentCopy))
            {
                ...
                {
                    string query = "INSERT INTO tbl_holidays (title,leave_date,section_id) VALUES ('" + tbSubject.Text + "','" + edtStartDate.DateTime.Date.ToString("yyyy-MM-dd") + "','" + sec + "'); ";
